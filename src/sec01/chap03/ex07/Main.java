...
public class Main {
    public static void main(String[] args) {
        Swordman r_swrdman1 = new Swordman(Side.RED);
        ...
        Horse<Knight> sonata = new Horse<>(40);

       avante.setRider(r_swrdman1);
        sonata.setRider(b_magicKnight1);

        r_swrdman1.defaultAttack(b_knight1);
        r_knight1.defaultAttack(b_magicKnight1);
        r_knight1.switchWeapon();
        r_knight2.defaultAttack(b_magicKnight2);

        b_magicKnight1.defaultAttack(r_swrdman1);
        b_magicKnight2.lightningAttack(new Unit[] {
                r_knight1,
                r_knight2,
                r_magicKnight1
        });
